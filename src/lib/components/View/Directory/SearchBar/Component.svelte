<script lang="ts">
	...
	let {
		...
		search = undefined,
		searchtitle = 'Search by directory name, or directory data...',
		joindepth = 0,
	...
	let directoryGroupsQCKey = $derived(
		Utils.MetadataModel.GetGroupQueryPropertiesByDatabaseProperties(metadatamodel, Domain.Entities.Directory.RepositoryName, joindepth)
	)
