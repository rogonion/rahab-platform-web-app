<script lang="ts">
	...
	const COMPONENT_NAME = 'view-group-authorization-rules-datum'
...
{#snippet datumlastupdatedon()}
	{@const fieldData = getDatumFieldData(
		...
		Domain.Entities.GroupAuthorizationRules.FieldColumn.LastUpdatedOn,
		joindepth
	)}
...
{#snippet datumcreatedon()}
	{@const fieldData = getDatumFieldData(
		Domain.Entities.GroupAuthorizationRules.RepositoryName,
		Domain.Entities.GroupAuthorizationRules.FieldColumn.CreatedOn,
		joindepth
	)}
	...
	<fieldset
		class="fieldset {theme === Domain.Entities.Theme.Theme.DARK
			...
			: !switchbackground
				...
				: 'border-gray-400 bg-gray-200'} rounded-box w-full border p-4"
	>
		<legend class="fieldset-legend">Rule Action ID</legend>
	...
	<fieldset
		class="fieldset {theme === Domain.Entities.Theme.Theme.DARK
			...
			: !switchbackground
				...
				: 'border-gray-400 bg-gray-200'} rounded-box w-full border p-4"
	>
		<legend class="fieldset-legend">Rule Section ID</legend>
