<script lang="ts">
	...
	const COMPONENT_NAME = 'view-metadata-models-datum'
...
{#snippet datumgroupid()}
	{@const fieldData = getDatumFieldData(
		...
		Domain.Entities.MetadataModels.FieldColumn.DirectoryGroupsID,
		joindepth
	)}
...
{#snippet datumcreatedon()}
	{@const fieldData = getDatumFieldData(
		Domain.Entities.MetadataModels.RepositoryName,
		Domain.Entities.MetadataModels.FieldColumn.CreatedOn,
		joindepth
	)}
...
{#snippet datumdeactivatedon()}
	{@const fieldData = getDatumFieldData(
		Domain.Entities.MetadataModels.RepositoryName,
		Domain.Entities.MetadataModels.FieldColumn.DeactivatedOn,
		joindepth
	)}
